...
int rendering_function(void *param) {
  ...
  if (gd->keys[KEY_UP]) {
    // if (gd->map[(int)gd->player.pos.y][(int)(gd->player.pos.x + gd->dir.x *
    // moveSpeed)] == false)
    gd->player.pos.x += gd->dir.x * moveSpeed;
    // if (gd->map[(int)(gd->player.pos.y + gd->dir.y *
    // moveSpeed)][(int)gd->player.pos.x] == false)
    gd->player.pos.y += gd->dir.y * moveSpeed;
    /*
    if (gd->map[(int)(gd->player.pos.y + gd->dir.y *
    moveSpeed)][(int)(gd->player.pos.x)] == false) gd->player.pos.y += gd->dir.y
    * moveSpeed; if (gd->map[(int)gd->player.pos.y][(int)(gd->player.pos.x +
    gd->dir.y * moveSpeed)] == false) gd->player.pos.y += gd->dir.y * moveSpeed;
    */
  }
